...
# ==============================================================================
# Ubuntu VM on an Incus host.
#
# Deliberately not a copy of ProxmoxVE's vm/ubuntu-vm.sh: that one downloads a
...
#
# Sized above Debian on purpose: snapd is present from first boot, keeps two
# revisions of every snap, and the base image is the largest of the mainstream
# server images.
# ==============================================================================
...
# Plain images:ubuntu/26.04 has no cloud-init. incus_vm_create switches to the
# /cloud variant automatically when cloud-init is enabled.
var_image="${var_image:-images:ubuntu/26.04}"
