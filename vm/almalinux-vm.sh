...
# ==============================================================================
# AlmaLinux VM on an Incus host.
#
# Deliberately not a copy of ProxmoxVE's vm/almalinux-vm.sh: that one downloads a
...
# Plain images:almalinux/10 has no cloud-init. incus_vm_create switches to the
