...
# ==============================================================================
# openEuler VM on an Incus host.
#
# ProxmoxVE ships no openEuler script at all, so there is nothing to mirror:
# Incus launches a VM image straight from a remote and configures it through
# native keys, which is all this script does.
# ==============================================================================

APP="openEuler"
APP_TYPE="vm"
var_os="${var_os:-openeuler}"
var_version="${var_version:-24.03}"
var_cpu="${var_cpu:-2}"
var_ram="${var_ram:-4096}"
var_disk="${var_disk:-24G}"
# Plain images:openeuler/24.03 has no cloud-init. incus_vm_create switches to
...
function advanced_settings() {
  ...
  # Guest configuration
  vm_prompt_cloud_init "openeuler"
